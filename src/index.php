...
<body>
    <h1> Wordle Clone </h1>
    <p>Made by Michael O'Sullivan and Demian Oportus</p>
    <hr>
    ...
    <div id="keyboard">
        ...
        <div id="secondKeyboardRow">
            ...
            <button class="keyboard-button">Delete</button>
        </div>
    ...
    <hr>
    <p>Note: We are relying on pure HTML/CSS/JS and no third-party resources, so guess words are not validated against a dictionary of real 5 letter words</p>
    <p>Example: AAAAA is a valid guess and will not raise an error</p>
    <p>Our word bank consists of 100 words</p>
